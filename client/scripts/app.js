    ...
    fetch: function(animate) {
      $.ajax({
        ...
        success: function(data) {
          ...
          // console.log('mostRecentMessage.objectId: ', mostRecentMessage.objectId, 'app.lastMessageId: ', app.lastMessageId);
          // console.log('app.roomname: ', app.roomname, 'displayedRoom: ', displayedRoom);
